...
opCmdBus.HeaderFile = 'Rte_Type.h';
...
% Bus object: ecuCmdBus 
clear elems;
elems(1) = Simulink.BusElement;
elems(1).Name = 'starter';
...
ecuCmdBus = Simulink.Bus;
ecuCmdBus.HeaderFile = 'Rte_Type.h';
ecuCmdBus.Description = '';
ecuCmdBus.DataScope = 'Auto';
ecuCmdBus.Alignment = -1;
ecuCmdBus.Elements = elems;
clear elems;
assignin('base','ecuCmdBus', ecuCmdBus);
